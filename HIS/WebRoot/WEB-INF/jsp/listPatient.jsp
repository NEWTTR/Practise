...
<!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
    	...
    	<!-- 按钮 -->
    	<form action="/HIS/patient/querysingle" method="post">
    	<div class="form-group">
    	<input type="text" class="form-control" id="p_num" name ="p_num" placeholder="病人编号">
    ...
    <c:forEach items="${cs}" var="c" varStatus="st">
        <tr>
            ...
            <td>${c.p_time}</td>
            <td>${c.p_status}</td>
            <td><a href="patient/queryPatient?p_num=${c.p_num}">修改</a>
  				<a href="patient/deletePatient?p_num=${c.p_num}">删除</a>
 			</td>   
        </tr>
    </c:forEach>
	</table>
