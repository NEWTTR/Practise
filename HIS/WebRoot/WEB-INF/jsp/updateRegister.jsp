...
<html lang="zh-CN">
 ...
 <!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
		<div class="panel-heading">修改挂号信息面板</div>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		<label for="inputnum" class="col-sm-2 control-label">病人编号：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_num" value="${c.r_num}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputname" class="col-sm-2 control-label">病人姓名：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_name" value="${c.r_name}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputprice" class="col-sm-2 control-label">病人药物：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_medicine" value="${c.r_medicine}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputtime" class="col-sm-2 control-label">病人挂号价格：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_price" value="${c.r_price}">
    			</div>
  		</div>
  		
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" onclick="updateRegister()">修改</button>
    </div>
  </div>
</form>
</div>
    ...
    function updateRegister() {
        ...
        form.action = "<%=basePath %>register/updateregister";
        form.method = "post";
        form.submit();
    }
</script>
