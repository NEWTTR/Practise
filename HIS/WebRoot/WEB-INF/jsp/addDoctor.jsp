...
<html lang="zh-CN">
  ...
  <!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
		<div class="panel-heading">添加医生面板</div>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		<label for="inputnum" class="col-sm-2 control-label"> 医生编号：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_num">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputname" class="col-sm-2 control-label"> 医生名称：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_username">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputprice" class="col-sm-2 control-label">医生密码：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_password">
    			</div>
  		</div>
  		<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" onclick="addDoctor()">新增</button>
    </div>
  </div>
</form>
</div>
    <script type="text/javascript">
        function addDoctor() {
            ...
            form.action = "<%=basePath %>doctor/addDoctor";
            form.method = "post";	
            form.submit();
        }
    </script>
