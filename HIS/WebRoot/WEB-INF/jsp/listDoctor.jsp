...
<!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
    	...
    	<!-- 按钮 -->
    	<form action="/HIS/doctor/querysingle" method="post">
    	<div class="form-group">
    	<input type="text" class="form-control" id="d_num" name ="d_num" placeholder="医生编号">
    ...
    <c:forEach items="${cs}" var="c" varStatus="st">
        <tr>
            ...
            <td>${c.d_name}</td>
            <td>${c.d_type}</td>
            <td><a href="doctor/queryDoctor?d_num=${c.d_num}">修改</a>
  				<a href="doctor/deleteDoctor?d_num=${c.d_num}">删除</a>
 			</td>   
        </tr>
    </c:forEach>
	</table>
