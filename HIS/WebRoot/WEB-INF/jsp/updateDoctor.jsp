...
<html lang="zh-CN">
 ...
 <!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
		<div class="panel-heading">修改医生面板</div>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		<label for="inputnum" class="col-sm-2 control-label"> 医生编号：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_num" value="${c.d_num}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputname" class="col-sm-2 control-label"> 医生名称：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_username" value="${c.d_username}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputprice" class="col-sm-2 control-label">医生密码：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_password" value="${c.d_password}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputquantity" class="col-sm-2 control-label">医生本名：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_name" value="${c.d_name}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputtime" class="col-sm-2 control-label">医生类型：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="d_type" value="${c.d_type}">
    			</div>
  		</div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" onclick="updateDoctor()">修改</button>
    </div>
  </div>
</form>
</div>
    ...
    function updateDoctor() {
        ...
        form.action = "<%=basePath %>doctor/updatedoctor";
        form.method = "post";
        form.submit();
    }
</script>
