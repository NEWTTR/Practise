...
<html lang="zh-CN">
  ...
  <!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
		<div class="panel-heading">挂号信息添加面板</div>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		<label for="inputnum" class="col-sm-2 control-label"> 病人编号：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_num">
    			</div>
  		</div>
  		<div class="form-group">
  		...
  		<div class="form-group">
    		<label for="inputprice" class="col-sm-2 control-label">病人药物：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="r_medicince">
    			</div>
  		</div>
  		<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" onclick="addRegister()">新增</button>
    </div>
  </div>
</form>
</div>
    <script type="text/javascript">
        function addRegister() {
            ...
            form.action = "<%=basePath %>register/addRegister";
            form.method = "post";	
            form.submit();
        }
    </script>
