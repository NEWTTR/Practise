...
<html lang="zh-CN">
 ...
 <!-- 左侧菜单栏 -->
	...
	<div class="panel panel-default">
		<div class="panel-heading">修改药品面板</div>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		<label for="inputnum" class="col-sm-2 control-label"> 药品编号：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="m_num" value="${c.m_num}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputname" class="col-sm-2 control-label"> 药品名称：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="m_name" value="${c.m_name}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputprice" class="col-sm-2 control-label">药品价格：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="m_price" value="${c.m_price}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputquantity" class="col-sm-2 control-label">药品数量：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="m_quantity" value="${c.m_quantity}">
    			</div>
  		</div>
  		<div class="form-group">
    		<label for="inputtime" class="col-sm-2 control-label">药品有效期：</label>
    			<div class="col-sm-10">
     			 <input type="text" class="form-control" name="m_time" value="${c.m_time}">
    			</div>
  		</div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary" onclick="updateMedicine()">修改</button>
    </div>
  </div>
</form>
</div>
    ...
    function updateMedicine() {
        ...
        form.action = "<%=basePath %>updatemedicine";
        form.method = "post";
        form.submit();
    }
</script>
